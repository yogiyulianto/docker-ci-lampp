...
class Konsultasi extends PrivateBase {

    const PAGE_TITLE = 'Konsultasi';
    const PAGE_HEADER = 'Konsultasi';
    const PAGE_URL = 'administrator/konsultasi/';
    ...
    public function __construct() {
        ...
        // LOAD MODEL
        $this->load->model('administrator/M_konsultasi');
        // LOAD LIBRARY
    ...
    public function index() {
        ...
        $total_row = $this->M_konsultasi->count_all();
        ...
        //get data 
        $rs_id = $this->M_konsultasi->get_all($from ,$config['per_page']);
        $data = array(
            'rs_id' => $rs_id,
