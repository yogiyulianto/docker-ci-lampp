					...
					<div class="col-8">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<input type="text" class="form-control" name="meta_title" value="{{old_input('meta_title')}}" placeholder="Meta Title"
									data-role="tagsinput">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<textarea class="form-control" name="meta_description" id="" cols="30" placeholder="Meta Description"
						...
						<div class="form-group row">
							<div class="col-lg-12">
								...
								<select name="is_weekly_content" id="is_weekly_content" class="select-2 " style="width:100%">
									...
									<option value="yes" {{ set_select(old_input('is_weekly_content') , 'yes') }}> Ya </option>
									<option value="no" {{ set_select(old_input('is_weekly_content') , 'no') }}> Tidak </option>
								</select>
						...
						<div class="form-group row">
							<div class="col-lg-12">
								...
								<input disabled type="text" id="weekly_content" class="form-control" name="weekly_content" placeholder="Masukan Minggu"
									value="{{old_input('weekly_content')}}" data-role="tagsinput">
