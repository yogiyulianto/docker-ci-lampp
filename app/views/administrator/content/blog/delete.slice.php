					...
					<div class="col-8">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<input disabled type="text" class="form-control" name="meta_title" value="{{$result['meta_title']}}">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<input disabled type="text" class="form-control" name="meta_keywords"
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<textarea disabled class="form-control" name="meta_description" id="" cols="30"
					...
					<div class="col-4">
						<div class="form-group row">
							<div class="col-lg-12">
								...
								<select disabled name="category_id" class="select-2 " style="width:100%">
						...
						<div class="form-group row">
							<div class="col-lg-12">
								...
								<select disabled name="blog_st" class="select-2 " style="width:100%">
						...
						<div class="form-group row">
							<div class="col-lg-12">
								...
								<select disabled name="pricing_st" class="select-2 " style="width:100%">
									<option value="0"> Pilih Status </option>
						...
						<div class="form-group row">
							<div class="col-lg-12">
								...
								<select disabled name="is_weekly_content" id="is_weekly_content" class="select-2 " style="width:100%">
