...
<div class="page-inner">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Ubah Kuis
        ...
        <form method="POST" action="{{$PAGE_URL.'edit_quiz_process'}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="title" class="form-control {{error_form_class('title')}}" placeholder="Masukan Judul Kuis" value="{{$result['title'] ?? ''}}">
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <textarea name="summary" class="form-control {{error_form_class('attachment') ?? ''}}" id="" cols="30" rows="10">{{$result['summary'] ?? ''}}</textarea>
