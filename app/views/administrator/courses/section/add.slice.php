...
<div class="page-inner">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">Tambahkan Bab
        ...
        <form method="POST" action="{{$PAGE_URL.'add_section_process'}}" >
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="title" class="form-control {{error_form_class('title')}}" placeholder="Masukan Judul Bab" value="{{old_input('title') ?? ''}}">
