        ...
        <form method="POST" action="{{$PAGE_URL.'edit_process'}}">
            ...
            <div class="card-body">
                ...
                <div class="col-lg-6">
                        ...
                        <input type="password" class="form-control {{error_form_class('user_pass_conf')}}" value="" name="user_pass_conf" placeholder="Password Fields">
                        <div class="error text-danger">{{error_form('user_pass_conf') ?? ''}}</div>
                    </div>
                    <div class="col-lg-6">
