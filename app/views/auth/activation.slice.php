...
<head>
	...
	<title>Aktivasi akun - GENDHIS ADMIN SYSTEM</title>
    ...
    <div class="container h-100">
        <div class="row h-100 justify-content-center align-items-center">
            ...
            <div class="jumbotron text-center">
                ...
                <p class="lead"><strong>Akun anda telah aktif!</strong> Anda sudah bisa menggunakan akun anda di aplikasi Mobile gendhis!</p>
                <hr>
                <p>
