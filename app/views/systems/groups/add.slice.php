            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="group_name" class="form-control {{error_form_class('group_name')}}" placeholder="Enter Group name" value="{{old_input('group_name') ?? ''}}">
                        <div class="error text-danger">{{error_form('group_name') ?? ''}}</div>
                    </div>
                    <div class="col-lg-6">
                        <label class="">Group Desc*</label>
                        <input type="text" name="group_desc" class="form-control {{error_form_class('group_desc')}}" placeholder="Enter Group desc" value="{{old_input('group_desc') ?? ''}}">
