            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="pref_group" class="form-control {{error_form_class('pref_group')}}" placeholder="Enter Group name" value="{{$result['pref_group'] ?? ''}}">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="pref_nm" class="form-control {{error_form_class('pref_nm')}}" placeholder="Enter Group desc" value="{{$result['pref_nm'] ?? ''}}">
                        <div class="error text-danger">{{error_form('pref_nm') ?? ''}}</div>
                    </div>
                    <div class="col-lg-6">
                        <label class="">Pref Label*</label>
                        <input type="text" name="pref_label" class="form-control {{error_form_class('pref_label')}}" placeholder="Enter Group desc" value="{{$result['pref_label'] ?? ''}}">
