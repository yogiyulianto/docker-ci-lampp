            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="role_name" class="form-control {{error_form_class('role_name')}}" placeholder="Enter Role Name" value="{{$result['role_name'] ?? ''}}">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="role_desc" class="form-control  {{error_form_class('role_desc')}}" placeholder="Enter Role Desc" value="{{$result['role_desc'] ?? ''}}">
                        <div class="error text-danger">{{error_form('role_desc') ?? ''}}</div>
                    </div>
                    <div class="col-lg-6">
                        <label class="">Role Default Page*</label>
                        <input type="text" name="default_page" class="form-control  {{error_form_class('default_page')}}" placeholder="Enter Default Page" value="{{$result['default_page'] ?? ''}}">
