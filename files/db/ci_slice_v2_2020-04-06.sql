...
# Generation Time: 2020-04-06 05:48:08 +0000
# ************************************************************
...
VALUES
	...
	('1585983401020004747','Created com_group','C','INSERT INTO `com_group` (`group_id`, `group_name`, `group_desc`, `mdb`, `mdb_name`, `mdd`) VALUES (\'03\', \'Programmer\', \'Programmer\', \'1911130001\', \'admin\', \'2020-04-04 08:56:40\')','http://localhost/CISLICE/ci-slice-v2/','{\"ip\":\"::1\",\"browser\":\"Chrome\",\"platform\":\"Mac OS X\"}','::1','1911130001','admin','2020-04-04 08:56:41'),
	('1585983405057962482','Updated com_group with group_id 03','U','UPDATE `com_group` SET `group_name` = \'Programmer\', `group_desc` = \'Programmer\', `mdb` = \'1911130001\', `mdb_name` = \'admin\', `mdd` = \'2020-04-04 08:56:45\'\nWHERE `group_id` = \'03\'','http://localhost/CISLICE/ci-slice-v2/','{\"ip\":\"::1\",\"browser\":\"Chrome\",\"platform\":\"Mac OS X\"}','::1','1911130001','admin','2020-04-04 08:56:45'),
	('1585983410068447644','Deleted com_group with group_id 03','D','DELETE FROM `com_group`\nWHERE `group_id` = \'03\'','http://localhost/CISLICE/ci-slice-v2/','{\"ip\":\"::1\",\"browser\":\"Chrome\",\"platform\":\"Mac OS X\"}','::1','1911130001','admin','2020-04-04 08:56:50'),
	('1586016034081721210','Created com_menu','C','INSERT INTO `com_menu` (`nav_id`, `portal_id`, `parent_id`, `nav_title`, `nav_desc`, `nav_url`, `nav_no`, `active_st`, `display_st`, `nav_icon`, `mdb`, `mdb_name`, `mdd`) VALUES (\'1000000020\', \'10\', \'1000000012\', \'Backup\', \'Database Backup\', \'systems/backup\', \'7\', \'1\', \'1\', \'\', \'1911130001\', \'admin\', \'2020-04-04 18:00:34\')','http://localhost/CISLICE/ci-slice-v2/','{\"ip\":\"::1\",\"browser\":\"Chrome\",\"platform\":\"Mac OS X\"}','::1','1911130001','admin','2020-04-04 18:00:34'),
	('1586016065010667814','Updated com_menu with nav_id 1000000020','U','UPDATE `com_menu` SET `portal_id` = \'10\', `parent_id` = \'1000000016\', `nav_title` = \'Backup\', `nav_desc` = \'Database Backup\', `nav_url` = \'systems/backup\', `nav_no` = \'7\', `active_st` = \'1\', `display_st` = \'1\', `nav_icon` = \'\', `mdb` = \'1911130001\', `mdb_name` = \'admin\', `mdd` = \'2020-04-04 18:01:05\'\nWHERE `nav_id` = \'1000000020\'','http://localhost/CISLICE/ci-slice-v2/','{\"ip\":\"::1\",\"browser\":\"Chrome\",\"platform\":\"Mac OS X\"}','::1','1911130001','admin','2020-04-04 18:01:05');
...
VALUES
	...
	('1000000020','10','1000000016','Backup','Database Backup','systems/backup',7,'1','1','','1911130001','admin','2020-04-04 18:01:05');
...
CREATE TABLE `com_user` (
  ...
  `mdb` varchar(10) DEFAULT NULL,
  `mdd` datetime DEFAULT NULL,
  `attempts` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
VALUES
	('1911130001','admin','$2a$08$QzNm594gVtMNhmojxypNDOEKKFfsLesHU.82ffUivIi1DOWfN3MCi',NULL,'2282622326','admin@codeinaja.net','1',NULL,'1911130001','2020-03-12 08:47:04','0'),
	('1911160001','aditya5660','$2a$08$lzpVwS/4r3fb.D77UlUkRuvbv6PpV6d9mJ7wNX5YNMY8I68oC3e8.',NULL,'','aditya5660@gmail.com','1',NULL,'1911160001','2020-03-28 16:27:13',NULL);
...
VALUES
	('1586012231068255230','1911130001','2020-04-04 16:57:11',NULL,'::1'),
	('1586012248073439347','1911130001','2020-04-04 16:57:28',NULL,'::1'),
	('1586012328016976579','1911130001','2020-04-04 16:58:48',NULL,'::1'),
	('1586012368056889541','1911130001','2020-04-04 16:59:28',NULL,'::1'),
	('1586015981080732638','1911130001','2020-04-04 17:59:41',NULL,'::1'),
	('1586058003019862328','1911130001','2020-04-05 05:40:03','2020-04-05 23:48:38','::1'),
	('1586070190066164266','1911130001','2020-04-05 09:03:10','2020-04-05 23:48:38','::1'),
	('1586071610030130544','1911130001','2020-04-05 09:26:50','2020-04-05 23:48:38','::1'),
	('1586104764073820634','1911130001','2020-04-05 18:39:24','2020-04-05 23:48:38','::1'),
	('1586105373002294534','1911130001','2020-04-05 18:49:33',NULL,'::1');
...
VALUES
	('1911130001','Administrator','Condong Catur','assets/images/users/1911130001_20200405074636.jpg','L','085335376496'),
